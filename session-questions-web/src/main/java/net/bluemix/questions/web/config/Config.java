 ...
 */
package net.bluemix.questions.web.config;

import java.util.List;

import net.bluemix.questions.web.xauth.CustomUserDetailsService;
import net.bluemix.questions.web.xauth.XAuthTokenConfigurer;
...
public class Config {
  ...
  @Configuration
  @Profile("cloud")
  static class WebCloudConfiguration extends AbstractCloudConfig {
